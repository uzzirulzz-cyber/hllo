...
export const INITIAL_USERS: User[] = [
  ...
  {
    id: 'usr-ai-001',
    name: 'Agent Concierge AI (Bot Seat)',
    email: 'ai.concierge@helloworld007.io',
    role: 'AI GREETER',
    avatarUrl: 'https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?w=150&auto=format&fit=crop&q=80',
    department: 'Automated Customer Greeter',
    assignedLeadCount: 150,
    conversionRate: 92.5,
    createdAt: '2025-03-12T11:00:00Z',
    greetingMessage: "Hello! Welcome to Hello World 007 CRM. I'm your AI Customer Concierge. How can our executive team assist your growth today?",
    isAiGreeter: true,
    greetingTrigger: 'NEW_INBOUND_LEAD',
    seatType: 'AI_GREETER_BOT',
  },
  {
    id: 'usr-ai-002',
    name: 'VIP Greeting Agent (Bot Seat)',
    email: 'vip.greeter@helloworld007.io',
    role: 'AI GREETER',
    avatarUrl: 'https://images.unsplash.com/photo-1633356122544-f134324a6cee?w=150&auto=format&fit=crop&q=80',
    department: 'VIP Enterprise Welcome',
    assignedLeadCount: 88,
    conversionRate: 96.1,
    createdAt: '2025-03-14T14:30:00Z',
    greetingMessage: "Welcome to Hello World Enterprise! I am your dedicated VIP Concierge. I have notified an executive lead manager for your account.",
    isAiGreeter: true,
    greetingTrigger: 'HOT_SCORE_LEAD',
    seatType: 'VIP_CONCIERGE',
  },
  {
    id: 'usr-104',
    name: 'Elena Rostova',
